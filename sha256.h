 ...
 */
void sha256_hex(const void *src, __SIZE_TYPE__  n_bytes, char *dst_hex65);

void sha256_bytes(const void *src, __SIZE_TYPE__  n_bytes, void *dst_bytes32);
...
void sha256_append(struct sha256 *sha, const void *data, __SIZE_TYPE__  n_bytes);
